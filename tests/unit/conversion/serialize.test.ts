...
describe("deterministic conversion", () => {
  ...
  it("wraps the exact fragment in the strict minimal document", () => {
    ...
    expect(result.html).toBe(
      '<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Markdown Preview</title></head><body><p><strong>Hello</strong></p></body></html>',
    );
  });
});
